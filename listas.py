# LPIII_2016 Hericson Rondon C.I 18620547
...
print "lista completa despues de eliminar el primero"
l.mostrar()

if (l.buscar_elem(30) == True):
	print "lo encontro"
else:
	print "no lo encontro"

print "muevo actual a la primera posicion"
l.pos_actual(1)
l.eliminar_primero()

print "como queda despues de eliminar el nuevo inicio"
l.mostrar()
